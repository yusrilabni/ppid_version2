...
const styles = StyleSheet.create({
  ...
  headerSection: { backgroundColor: '#fff', paddingHorizontal: 20, paddingBottom: 15, borderBottomLeftRadius: 30, borderBottomRightRadius: 30, elevation: 15, shadowColor: '#1e293b', shadowOpacity: 0.1, shadowRadius: 20 },
  ...
  listContainer: { padding: 15, paddingTop: 20, paddingBottom: 100 },
