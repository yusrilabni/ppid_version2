    ...
    <div class="max-w-7xl mx-auto w-full">
        ...
        <div class="mb-8">
            ...
            <div class="mt-8 mb-10">
                <form id="searchForm" method="GET" action="" onsubmit="event.preventDefault(); updateContent();">
                        ...
                        @auth
                            ...
                            <label class="relative flex items-center cursor-pointer group select-none">
                                ...
                                <div class="px-6 py-3 rounded-2xl bg-white border border-gray-100 shadow-sm transition-all duration-300 flex items-center gap-3 
                                    ...
                                    <span class="text-[10px] font-black uppercase tracking-[0.15em] label-text">
        ...
        <div id="contentArea" class="relative min-h-[400px]">
            ...
            <div id="loadingOverlay" class="absolute inset-0 bg-white/40 backdrop-blur-[4px] z-[60] flex items-center justify-center hidden rounded-[3rem] transition-all duration-300">
                <div class="flex flex-col items-center bg-white p-8 rounded-[2rem] shadow-2xl border border-gray-50">
...
<script>
    ...
    async function updateContent(url = null) {
        ...
        // Use provided URL (for pagination) or current pathname with params
        ...
        try {
            ...
            // Re-update labels based on checkbox state after content load
            updateLabels();
    ...
    function updateLabels() {
        ...
        if (checkUnit) {
            const label = checkUnit.closest('label').querySelector('.label-text');
            label.innerText = checkUnit.checked ? 'Tampilkan Semua Unit' : 'Hanya Unit Saya';
        }
        const checkCreated = document.getElementById('check_created');
        if (checkCreated) {
            const label = checkCreated.closest('label').querySelector('.label-text');
            label.innerText = checkCreated.checked ? 'Urutkan Tgl Dokumen' : 'Waktu Sistem Terbaru';
        }
    }
    ...
    function clearFilters() {
        ...
        // Standard select resets
        document.querySelector('select[name="sort"]').value = 'tanggal_upload_desc';
    ...
    // Initial pagination interception
