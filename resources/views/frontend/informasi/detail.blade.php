...
@section('meta')
    ...
    <meta name="twitter:title" content="{{ $informasi->title }} - PPID Kabupaten Sinjai">
    <meta name="twitter:description" content="{{ Str::limit(strip_tags($informasi->deskripsi), 160) }}">
