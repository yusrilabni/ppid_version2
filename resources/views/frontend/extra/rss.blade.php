...
<div class="bg-gray-50 py-12">
    <div class="container mx-auto px-4 max-w-6xl">
        ...
        <div class="text-center mb-12">
            ...
            <h1 class="text-4xl font-extrabold text-gray-900 mb-4 tracking-tight uppercase">RSS Feed & Integrasi</h1>
            <p class="text-lg text-gray-600 max-w-3xl mx-auto">Gunakan feed XML otomatis untuk website atau aplikasi Anda.</p>
        </div>
            ...
            <div class="lg:col-span-2 space-y-8">
                <section class="bg-white rounded-3xl shadow-sm border border-gray-100 p-8">
                    ...
                    <p class="text-gray-600 text-sm leading-relaxed">
                        RSS adalah format standar untuk berlangganan informasi. Dengan URL ini, platform lain bisa mengambil data terbaru secara otomatis setiap kali admin melakukan pembaruan di website PPID.
                    </p>
                </section>

                <section class="bg-white rounded-3xl shadow-sm border border-gray-100 p-8">
                    <h2 class="text-xl font-bold mb-6 flex items-center text-orange-600">
                        <span class="w-2 h-8 bg-orange-500 rounded-full mr-3"></span> Kustomisasi URL (Filter)
                    </h2>
            ...
            <div class="space-y-8">
                <section class="bg-white rounded-3xl shadow-sm border border-gray-100 p-6">
                    <h2 class="text-lg font-bold mb-4 flex items-center text-blue-600 uppercase tracking-tighter">
                        <i class="fas fa-sync-alt mr-2 text-sm"></i> Auto Post
                    </h2>
                    <p class="text-xs text-gray-500 leading-relaxed">
                        Gunakan IFTTT atau Zapier untuk memposting otomatis update kami ke Sosmed Anda.
                    </p>
                </section>
                ...
                <section class="bg-orange-600 rounded-3xl shadow-lg p-6 text-white relative overflow-hidden group">
                    ...
                    <p class="text-[11px] opacity-95 text-center">Tata Letak > Tambah Gadget > Feed.</p>
                </section>
            </div>
        </div>
        ...
        <div class="mt-12" x-data="rssCodeHandler()">
            <section class="bg-white rounded-[3.5rem] shadow-2xl border border-gray-100 p-8 md:p-14 overflow-hidden text-gray-800">
                <h2 class="text-3xl font-black mb-8 flex items-center tracking-tight">
                ...
                <div class="flex space-x-6 mb-10 border-b-2 border-gray-100">
                    <button @click="motherTab = 'card'; showPreview = false" :class="motherTab === 'card' ? 'text-blue-600 border-b-4 border-blue-600 -mb-[2px]' : 'text-gray-400'" class="pb-4 text-xl font-black uppercase tracking-tighter transition-all">
                        <i class="fas fa-th-large mr-2"></i> Tampilan Kartu
                    </button>
                    <button @click="motherTab = 'list'; showPreview = false" :class="motherTab === 'list' ? 'text-blue-600 border-b-4 border-blue-600 -mb-[2px]' : 'text-gray-400'" class="pb-4 text-xl font-black uppercase tracking-tighter transition-all">
                ...
                <div class="bg-gray-900 rounded-[3rem] shadow-2xl relative overflow-hidden flex flex-col min-h-[550px] border-8 border-gray-800">
                    ...
                    <div class="p-6 border-b border-white/5 flex items-center justify-between bg-white/5">
                        ...
                        <div class="flex space-x-3">
                            <button @click="copyCode()" class="bg-blue-600 hover:bg-blue-700 text-white px-6 h-10 rounded-xl text-xs font-black uppercase tracking-widest transition-all flex items-center shadow-lg">
                    ...
                    <div class="relative flex-grow">
                        ...
                        {{-- CODE AREA (PURE TEXT - SAFE FROM BLADE ENGINE) --}}
...
&lt;/style&gt;
&lt;div id="ppid-grid" class="ppid-grid"&gt;Memuat...&lt;/div&gt;
&lt;script&gt;
...
&lt;div class="grid grid-cols-3 gap-6"&gt;
    &commat;foreach($feeds as $item)
        &lt;div class="card"&gt;
            &lt;h4&gt;&lbrace;&#123; $item->title &rbrace;&#125;&lt;/h4&gt;
            &lt;small&gt;&lbrace;&#123; $item->organization &rbrace;&#125;&lt;/small&gt;
        &lt;/div&gt;
    &commat;endforeach
...
?&gt;</code></pre></template>
    ...
    &lt;div&gt;&lbrace;&#123; $item->title &rbrace;&#125;&lt;/div&gt;
