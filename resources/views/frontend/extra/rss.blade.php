...
<div class="bg-gray-50 py-12">
    <div class="container mx-auto px-4 max-w-6xl">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-8 text-gray-800">
                ...
                <section class="bg-white rounded-3xl shadow-sm border border-gray-100 p-8">
                    ...
                    <div class="bg-gray-900 rounded-2xl p-6 text-[11px] font-mono text-gray-300 space-y-4 border-l-4 border-orange-500 shadow-xl">
                        ...
                        <div>
                            ...
                            <code class="break-all text-white">{{ route('extra.rss.generate') }}?limit=6</code>
                        </div>
                ...
                {{-- 3. Panduan WordPress Detail --}}
                <section class="bg-white rounded-3xl shadow-sm border border-gray-100 p-8">
                    <h2 class="text-2xl font-bold mb-6 flex items-center">
                        <i class="fab fa-wordpress text-blue-500 mr-3 text-3xl"></i> Panduan Lengkap WordPress
                    </h2>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 text-sm text-gray-600">
                        <div class="space-y-4">
                            <h3 class="font-bold text-gray-800 uppercase tracking-wider text-xs">Langkah Pemasangan:</h3>
                            <ol class="list-decimal ml-5 space-y-3">
                                <li>Buka editor halaman/postingan WordPress Anda.</li>
                                <li>Klik tombol <strong>(+)</strong> dan cari blok <strong>"RSS"</strong>.</li>
                                <li>Tempelkan URL Feed yang sudah Anda kustomisasi di atas.</li>
                                <li>Klik tombol <strong>"Gunakan URL"</strong>.</li>
                            </ol>
                        </div>
                        <div class="bg-blue-50 p-6 rounded-2xl border border-blue-100">
                            <h3 class="font-bold text-blue-800 mb-3 text-xs uppercase">Pengaturan Tampilan:</h3>
                            <ul class="space-y-2 text-xs text-blue-900/70 italic">
                                <li class="flex items-center"><i class="fas fa-check-circle mr-2 text-blue-500"></i> Aktifkan "Tampilkan Ringkasan"</li>
                                <li class="flex items-center"><i class="fas fa-check-circle mr-2 text-blue-500"></i> Aktifkan "Tampilkan Penulis"</li>
                                <li class="flex items-center"><i class="fas fa-check-circle mr-2 text-blue-500"></i> Aktifkan "Tampilkan Tanggal"</li>
                                <li class="flex items-center"><i class="fas fa-list-ol mr-2 text-blue-500"></i> Set "Jumlah Item" (Sesuai kebutuhan)</li>
                            </ul>
                        </div>
                    </div>
                </section>

                {{-- 4. Struktur Data Detail --}}
                <section class="bg-white rounded-3xl shadow-sm border border-gray-100 p-8">
                    <h2 class="text-2xl font-bold mb-6 flex items-center">
            ...
            <div class="space-y-8">
                ...
                <section class="bg-white rounded-3xl shadow-sm border border-gray-100 p-6 text-gray-800">
                    ...
                    <div class="text-xs text-gray-600 space-y-4 leading-relaxed">
                        <p>Bagikan update otomatis ke akun <strong>Facebook, X, atau Telegram</strong> tanpa mengetik ulang dengan metode <strong>Trigger & Action</strong>:</p>
                        <div class="space-y-2">
                            ...
                            <div class="flex items-center p-2.5 bg-gray-50 rounded-xl border border-gray-100 font-bold italic text-[10px]">
                                <i class="fas fa-robot text-blue-500 w-6 text-center mr-2"></i> 2. Robot Bridge
                            </div>
                            <div class="flex items-center p-2.5 bg-gray-50 rounded-xl border border-gray-100 font-bold italic text-[10px]">
                        ...
                        <p class="bg-blue-50 p-3 rounded-xl italic text-[10px] text-blue-700 border border-blue-100">
                            "Setiap kali admin upload data, robot akan memposting judul & link-nya otomatis ke sosmed Anda."
                        </p>
                    </div>
                </section>
                ...
                <section class="bg-orange-600 rounded-3xl shadow-lg p-6 text-white relative overflow-hidden group">
                    ...
                    <h3 class="text-lg font-bold mb-2 uppercase tracking-widest text-center">Blogger</h3>
                    <div class="space-y-2 text-[11px] opacity-95 text-center leading-relaxed font-medium">
                        <p>Dashboard Blogger > Tata Letak > Tambah Gadget > Pilih <strong>"Feed"</strong> > Tempel URL.</p>
                    </div>
                </section>

                {{-- C. FAQ --}}
                <section class="bg-white rounded-3xl shadow-sm border border-gray-100 p-6 text-gray-800">
                    <h3 class="text-sm font-black mb-4 uppercase tracking-widest text-center border-b pb-2 text-gray-400">Tanya Jawab</h3>
                    <div class="space-y-4 text-[11px]">
                        <div>
                            <p class="font-bold text-gray-700">Apakah Real-time?</p>
                            <p class="text-gray-500">Ya, data terupdate seketika saat admin menyimpan informasi baru.</p>
                        </div>
                        <div>
                            <p class="font-bold text-gray-700">Apakah Gratis?</p>
                            <p class="text-gray-500">Layanan ini 100% gratis untuk mendukung keterbukaan informasi.</p>
                        </div>
                    </div>
                </section>
                ...
                <section class="bg-white rounded-3xl shadow-sm border border-gray-100 p-6">
                    <div class="space-y-3">
                        <a href="https://ifttt.com" target="_blank" class="flex items-center p-3 bg-gray-50 rounded-xl hover:bg-black hover:text-white transition-all group border border-gray-100">
                            ...
                            <div class="text-[10px] font-black uppercase tracking-widest">IFTTT</div>
                        </a>
                        <a href="https://zapier.com" target="_blank" class="flex items-center p-3 bg-gray-50 rounded-xl hover:bg-orange-500 hover:text-white transition-all group border border-gray-100">
                            ...
                            <div class="text-[10px] font-black uppercase tracking-widest">Zapier</div>
                        </a>
                    </div>
                </section>
            </div>
            ...
            <section class="bg-white rounded-[3.5rem] shadow-2xl border border-gray-100 p-8 md:p-14 overflow-hidden text-gray-800">
                <div class="flex flex-col md:flex-row md:items-center justify-between mb-10">
                    ...
                    <div class="flex space-x-3">
                        <button @click="copyCode()" class="bg-blue-600 hover:bg-blue-700 text-white px-6 h-12 rounded-2xl text-xs font-black uppercase tracking-widest transition-all shadow-lg flex items-center">
                        ...
                        <div x-show="showPreview" class="bg-[#fcfcfc] p-8 md:p-14 h-full min-h-[450px] overflow-y-auto">
                            <div class="flex justify-between items-center mb-8 border-b-2 border-gray-100 pb-5">
                                <div class="flex items-center">
                                    ...
                                    <h3 class="text-[10px] font-black text-gray-400 uppercase tracking-widest">Aktual Live Result</h3>
                                </div>
                                <button @click="showPreview = false" class="text-[10px] font-black text-red-400 hover:text-red-600 uppercase tracking-widest">Tutup Pratinjau [X]</button>
                            </div>
  ...
  /* KUSTOMISASI: CSS di bawah ini bisa Anda hapus, custom, atau rubah sesuai selera */
  ...
  .ppid-card:hover { transform: translateY(-5px); box-shadow: 0 10px 20px rgba(0,0,0,0.1); }
  .ppid-title { font-weight: 800; color: #1a1a1a; text-decoration: none; font-size: 15px; display: block; margin: 10px 0; line-height: 1.4; }
    ...
    items.forEach(el => {
      ...
      html += `&lt;div class="ppid-card"&gt;
                 &lt;div style="display:flex; justify-content:space-between; margin-bottom:10px;"&gt;
                   &lt;span style="font-size:10px; font-weight:bold; color:#0052FF;"&gt;🏛️ ${el.querySelector("organization").textContent}&lt;/span&gt;
                 ...
                 &lt;small style="color:#999; margin-top:auto;"&gt;📅 ${new Date(el.querySelector("pubDate").textContent).toLocaleDateString('id-ID')}&lt;/small&gt;
               &lt;/div&gt;`;
    });
...
foreach ($rss->channel->item as $info) {
    echo "&lt;div style='background:#fff; padding:20px; border-radius:15px; border:1px solid #eee;'&gt;
            &lt;strong&gt;{$info->title}&lt;/strong&gt;&lt;br&gt;&lt;small&gt;{$info->organization}&lt;/small&gt;
          &lt;/div&gt;";
}
echo "&lt;/div&gt;";
?&gt;</code></pre></template>
                    ...
                    if(this.motherTab === 'card') {
                        ...
                        items.forEach((el, index) => {
                            ...
                            html += `<div style="padding:20px 30px; border-bottom:${index === items.length-1 ? 'none' : '1px solid #f5f5f5'}; display:flex; align-items:center; justify-content:space-between;">
                                ...
                                <span style="font-size:9px; font-weight:800; padding:2px 10px; border-radius:20px; background:${color}10; color:${color}; border:1.5px solid ${color}20;">${status}</span>
                            </div>`;
                        });
                        html += '</div>';
                    }
