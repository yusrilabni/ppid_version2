        ...
        <section class="py-6 md:py-10 bg-white">
            <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="relative group px-0">
                    <div class="swiper-pagination latest-info-pagination !relative !top-0 !bottom-auto mb-1 mt-1 md:mt-2"></div>
                    <div class="swiper-container latest-info-carousel overflow-hidden pt-0">
                        <div class="swiper-wrapper">
                            @foreach ($latestInformasis as $info)
                                ...
                                <div class="swiper-slide h-auto">
                                    <div class="bg-white rounded-2xl md:rounded-3xl border-l-4 border-{{ $catColor }}-500 shadow-sm hover:shadow-2xl transition-all duration-500 h-full flex flex-col group/card p-4 md:p-6 hover:-translate-y-2 relative overflow-hidden m-1">
                            ...
                            @foreach ($informasiItems as $item)
                                ...
                                <div class="swiper-slide h-auto">
                                    <div class="h-full w-full">
                                        <div class="bg-white rounded-2xl shadow-lg md:shadow-xl hover:shadow-2xl transition-all duration-300 h-full flex flex-col group border border-gray-200 overflow-hidden min-h-[320px] md:min-h-[400px] m-1">
...
@push('scripts')
    <script>
        function initHomePlugins() {
            ...
            new Swiper('.latest-info-carousel', { slidesPerView: 1, centeredSlides: true, spaceBetween: 20, loop: true, autoplay: { delay: 4000, disableOnInteraction: false }, navigation: { nextEl: '.latest-info-next', prevEl: '.latest-info-prev' }, pagination: { el: '.latest-info-pagination', clickable: true }, breakpoints: { 640: { slidesPerView: 2, centeredSlides: false }, 1024: { slidesPerView: 3, centeredSlides: false }, 1280: { slidesPerView: 4, centeredSlides: false } } });
            new Swiper('.news-carousel', { slidesPerView: 1, centeredSlides: true, spaceBetween: 20, loop: true, autoplay: { delay: 5000, disableOnInteraction: false }, pagination: { el: '.news-pagination', clickable: true }, navigation: { nextEl: '.news-button-next', prevEl: '.news-button-prev' }, breakpoints: { 640: { slidesPerView: 2, slidesPerGroup: 1, centeredSlides: false }, 768: { slidesPerView: 3, slidesPerGroup: 1, centeredSlides: false }, 1024: { slidesPerView: 4, slidesPerGroup: 1, centeredSlides: false } } });
            new Swiper('.info-carousel', { slidesPerView: 1, centeredSlides: true, spaceBetween: 20, loop: false, autoHeight: true, pagination: { el: '.info-pagination', clickable: true }, navigation: { nextEl: '.info-button-next', prevEl: '.info-button-prev' }, breakpoints: { 640: { slidesPerView: 1 }, 768: { slidesPerView: 2, centeredSlides: false }, 1024: { slidesPerView: 3, centeredSlides: false } } });
