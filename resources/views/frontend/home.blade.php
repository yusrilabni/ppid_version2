    ...
    <script>
        function initHomePlugins() {
            ...
            var latestInfoSwiper = new Swiper('.latest-info-carousel', {
                ...
                on: { init: function() { this.el.classList.remove('loading'); } }
            });
            ...
            if (contactForm && !contactForm.dataset.initialized) {
                ...
                contactForm.addEventListener('submit', async function(e) {
                    ...
                    const mailBody = `Saya ${formData.get('name')}, dengan email ${formData.get('email')}, ingin menyampaikan: ${formData.get('message')}`;
        ...
        // Pastikan plugin diinisialisasi baik pada load pertama maupun saat pindah halaman via Turbo
