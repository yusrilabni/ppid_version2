...
<head>
    ...
    <style>
        ...
        #acc-main-wrapper.acc-contrast-light, 
        #acc-main-wrapper.acc-contrast-light *:not(.acc-ignore):not(.acc-ignore *),
        #acc-main-wrapper.acc-contrast-light section,
        #acc-main-wrapper.acc-contrast-light div { 
        ...
        #acc-main-wrapper.acc-contrast-dark, 
        #acc-main-wrapper.acc-contrast-dark *:not(.acc-ignore):not(.acc-ignore *),
        #acc-main-wrapper.acc-contrast-dark section,
        #acc-main-wrapper.acc-contrast-dark div { 
