...
<head>
    ...
    <style>
        ...
        /* Widget UI Styles */
        .acc-widget-container { font-family: 'Inter', sans-serif !important; font-size: 16px !important; }
        ...
        #reading-guide { position: fixed; width: 100%; height: 4px; background: #0052FF; pointer-events: none; z-index: 999999; display: none; }
        body.acc-focus-guide #reading-guide { display: block !important; }
    </style>
    @stack('styles')
</head>
...
<body class="antialiased bg-gray-100 text-gray-800"
    ...
    <script>
        function accessibilityWidget() {
            return {
                isSoundEnabled: true, isReaderActive: false, isHoverActive: false, hoverTimeout: null,
                init() {
                    ...
                    document.addEventListener('mousemove', (e) => {
                        ...
                        if (guide && Alpine.store('accConfig').focus === 'guide') { guide.style.top = e.clientY + 'px'; }
                    });
                    ...
                    document.addEventListener('mouseover', (e) => { if (this.isSoundEnabled && this.isHoverActive && !e.target.closest('.acc-widget-container')) { clearTimeout(this.hoverTimeout); this.hoverTimeout = setTimeout(() => this.handleElementSource(e.target), 600); } });
                },
                ...
                handleElementSource(target) {
                    const el = target.closest('a, button, h1, h2, h3, h4, h5, h6, p, li, span, img, label');
                    if (!el) return;
