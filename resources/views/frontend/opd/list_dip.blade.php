...
@section('title', 'Daftar Informasi Publik per OPD')
...
<div class="container mx-auto py-8 px-4">
    <div class="max-w-7xl mx-auto">
        <x-breadcrumbs :breadcrumbs="[
            ...
            ['title' => 'DIP per OPD', 'url' => '', 'icon' => 'fas fa-file-invoice']
        ]" />

        <div class="mb-10 text-center">
            <h1 class="text-3xl font-extrabold text-gray-900 md:text-4xl mb-4">Daftar Informasi Publik (DIP) per OPD</h1>
            <p class="text-lg text-gray-600 max-w-2xl mx-auto">Silakan pilih Organisasi Perangkat Daerah (OPD) di bawah ini untuk melihat Daftar Informasi Publik yang mereka kelola.</p>
        </div>
