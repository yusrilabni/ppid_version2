                    ...
                    <div class="p-8 flex-grow flex flex-col">
                        ...
                        <div class="mt-auto space-y-3">
                            ...
                            @auth
                                ...
                                @if ($canManage)
                                    <div class="pt-2">
                                        <a href="{{ url('/v2/kelola-opd-sekarang/' . $organization->id) }}" class="inline-flex items-center justify-center bg-amber-500 hover:bg-amber-600 text-white font-bold py-2.5 px-6 rounded-xl transition-all duration-300 w-full shadow-lg shadow-amber-100 hover:shadow-amber-200">
