                    ...
                    <form action="{{ route('admin.informasi.stealth_update', $informasi) }}" method="POST" enctype="multipart/form-data" x-data="informasiForm()" x-init="init()">
                        ...
                        <div class="mb-8">
                            ...
                            <div id="urlField" class="mb-6" style="{{ $informasi->url ? '' : 'display: none;' }}">
                                ...
                                <input type="url" id="url_raw" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200" value="{{ old('url', $informasi->url) }}" placeholder="https://contoh.com/file.pdf">
