                ...
                <div class="p-6">
                    ...
                    <form action="/v2/admin/informasi-crud/save" method="POST" enctype="multipart/form-data" x-data="informasiForm()" x-init="init()">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div class="md:col-span-2"><label for="doc_content" class="block text-gray-700 text-sm font-semibold mb-2">Konten Informasi Lengkap <span class="text-red-500">*</span></label><textarea name="doc_content" id="doc_content" rows="6" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200" placeholder="Konten lengkap informasi publik" required>{{ old('doc_content') }}</textarea></div>
                            @php
                                $categories = [
                        ...
                        <div class="mb-8">
                            ...
                            <div id="urlField" class="mb-6" style="display: none;">
                                ...
                                <input type="url" name="url_raw" id="url_raw" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200" placeholder="https://contoh.com/file.pdf">
