...
@section('content')
    <div class="bg-white rounded-xl shadow p-6">
        <div class="mb-6">
            <h2 class="text-xl font-bold text-gray-800">Tambah Jabatan Baru</h2>
            <p class="text-gray-600">Tambahkan jabatan baru ke dalam struktur organisasi</p>
        </div>
        ...
        <form action="{{ route('admin.positions.store') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="text" name="name" id="name" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 transition" value="{{ old('name') }}">
            ...
            <div class="mb-6">
                ...
                <input type="number" name="order_number" id="order_number" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 transition" value="{{ old('order_number', 0) }}" min="0">
