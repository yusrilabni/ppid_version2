    ...
    <div class="container mx-auto p-4">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    <h1 class="text-2xl sm:text-3xl font-bold text-gray-900">Buat Survei Baru</h1>
                    <p class="text-gray-600 mt-1">Isi formulir berikut untuk membuat survei baru</p>
                </div>
                ...
                <div class="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-indigo-50">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600">Lengkapi detail survei Anda</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="relative">
                                <input type="text" name="title" id="title"
                                    ...
                                    placeholder="Masukkan judul survei" value="{{ old('title') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="relative">
                                <textarea name="description" id="description" rows="4"
                                    class="block w-full px-4 py-3 pl-10 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-150 ease-in-out"
                                    placeholder="Deskripsikan tujuan survei ini">{{ old('description') }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="relative">
                                    <select name="type" id="type"
                                        class="block w-full px-4 py-3 pl-10 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 appearance-none bg-white transition duration-150 ease-in-out">
                                        <option value="default" {{ old('type', 'default') == 'default' ? 'selected' : '' }}
                                            class="py-2">Default</option>
                                        <option value="publik" {{ old('type') == 'publik' ? 'selected' : '' }}
                                            class="py-2">Publik</option>
                                        <option value="private" {{ old('type') == 'private' ? 'selected' : '' }}
                                            class="py-2">Private</option>
                                        <option value="skm" {{ old('type') == 'skm' ? 'selected' : '' }}
                                            class="py-2">SKM</option>
                                        <option value="ppid" {{ old('type') == 'ppid' ? 'selected' : '' }}
            ...
            <div class="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-5">
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <h3 class="text-sm font-medium text-blue-800">Tips Membuat Survei</h3>
                        <div class="mt-2 text-sm text-blue-700">
                            <ul class="list-disc list-inside space-y-1">
                                <li>Pastikan judul survei jelas dan deskriptif</li>
                                <li>Atur tanggal survei sesuai kebutuhan</li>
                                <li>Gunakan status "Draft" jika survei belum siap dipublikasikan</li>
                                <li>Setelah disimpan, Anda dapat menambahkan pertanyaan pada survei</li>
                            </ul>
                        </div>
                    </div>
                </div>
