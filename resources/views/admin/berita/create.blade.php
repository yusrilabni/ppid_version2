...
@section('content')
    <div class="bg-white rounded-xl shadow p-6">
        <div class="mb-6">
            <h2 class="text-xl font-bold text-gray-800">Create New Berita</h2>
            <p class="text-gray-600">Add a new news article to the website</p>
        </div>
        ...
        <form action="{{ route('admin.berita.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <x-forms.tiny-mce-editor id="content" name="content" rows="10" required>{{ old('content') }}</x-forms.tiny-mce-editor>
            </div>

            <div class="mb-6">
                <label for="excerpt" class="block text-sm font-medium text-gray-700 mb-2">Excerpt</label>
                <textarea name="excerpt" id="excerpt" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 transition" rows="3">{{ old('excerpt') }}</textarea>
            ...
            <div class="mb-6">
                ...
                <p class="mt-2 text-sm text-gray-500">Upload an image for the news article (JPG, PNG, GIF)</p>
            </div>
            ...
            <div class="mb-6">
                ...
                <div class="flex items-center">
                    ...
                    <input type="checkbox" name="published" id="published" value="1" class="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500" {{ old('published') ? 'checked' : '' }}>
