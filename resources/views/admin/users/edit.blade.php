    ...
    <div class="bg-white rounded-xl shadow p-6">
        ...
        <form action="{{ route('admin.users.update', $user) }}" method="POST" x-data="{ role: '{{ old('role', $user->role) }}' }">
            ...
            <div class="mb-6">
                ...
                <input type="text" name="nip" id="nip" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 transition" value="{{ old('nip', $user->nip) }}">
