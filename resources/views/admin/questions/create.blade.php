...
@section('title', 'Tambah Pertanyaan: ' . $survey->title)
    ...
    <div class="container mx-auto p-4">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    <h1 class="text-2xl sm:text-3xl font-bold text-gray-900">Tambah Pertanyaan</h1>
                    <p class="text-gray-600 mt-1">Survei: {{ $survey->title }}</p>
                </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden" 
                 x-data="questionForm({{ json_encode($errors->get('options.*.text')) }}, {{ old('options') ? json_encode(old('options')) : 'null' }})">
                ...
                <div class="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-indigo-50">
                    <div class="flex items-center">
                        ...
                        <div>
                            <h2 class="text-lg font-semibold text-gray-900">Detail Pertanyaan</h2>
                            <p class="text-sm text-gray-600">Tentukan teks, jenis, dan opsi jawaban</p>
                        </div>
                    </div>
                </div>
                ...
                <form action="{{ route('admin.surveys.questions.store', $survey) }}" method="POST" class="p-6">
                    @csrf
...
<script>
    function questionForm(errors = {}, oldOptions = null) {
        return {
            question_type: 'Isian Singkat',
            question_text: '',
            options: oldOptions ? oldOptions : [{ text: '', value: '' }],
            errors: errors,
