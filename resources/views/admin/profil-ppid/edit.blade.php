...
@section('content')
    <div class="bg-white rounded-xl shadow p-6">
        <h2 class="text-xl font-bold text-gray-800 mb-6">Edit Profil PPID</h2>
        ...
        <form action="{{ route('admin.profil-ppid.update', $profilPpid->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <select name="status" id="status" class="form-select w-full rounded-md shadow-sm border-gray-300 focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                            <option value="1" {{ old('status', $profilPpid->status) == 1 ? 'selected' : '' }}>Aktif</option>
                            <option value="0" {{ old('status', $profilPpid->status) == 0 ? 'selected' : '' }}>Nonaktif</option>
                        </select>
            ...
            <div class="mb-6">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="vision" id="vision" rows="5" class="form-textarea w-full rounded-md shadow-sm border-gray-300 focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">{{ old('vision', $profilPpid->vision) }}</textarea>
                ...
                <div class="mb-4">
                    ...
                    <div id="mission_fields_container">
                        @php
                            $missions = old('mission', $profilPpid->mission ?? ['']);
                            if (!is_array($missions)) {
                                $missions = [$missions];
                            }
                        @endphp
                        @foreach($missions as $index => $missionText)
            ...
            <div class="mb-6">
                ...
                <div class="mb-4">
                    ...
                    <div id="structure_image_preview" class="mt-2">
                        @if($profilPpid->structure_image)
                            <img src="{{ asset('storage/' . $profilPpid->structure_image) }}" alt="Struktur PPID" class="w-24 h-24 object-cover rounded-md">
                        @endif
                    </div>
                </div>
            </div>
            ...
            <div class="mb-6">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="address" id="address" rows="3" class="form-textarea w-full rounded-md shadow-sm border-gray-300 focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">{{ old('address', $profilPpid->address) }}</textarea>
                    <x-input-error :messages="$errors->get('address')" class="mt-2" />
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                        <label for="phone" class="block text-sm font-medium text-gray-700 mb-1">Nomor Telepon</label>
                        <input type="text" name="phone" id="phone" class="form-input w-full rounded-md shadow-sm border-gray-300 focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50" value="{{ old('phone', $profilPpid->phone) }}">
                        <x-input-error :messages="$errors->get('phone')" class="mt-2" />
                    </div>
                    <div>
                        <label for="email" class="block text-sm font-medium text-gray-700 mb-1">Email Resmi</label>
                        <input type="email" name="email" id="email" class="form-input w-full rounded-md shadow-sm border-gray-300 focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50" value="{{ old('email', $profilPpid->email) }}">
            ...
            <div class="mb-6">
                ...
                <div class="mb-4">
                    ...
                    <input type="url" name="maps_url" id="maps_url" class="form-input w-full rounded-md shadow-sm border-gray-300 focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50" value="{{ old('maps_url', $profilPpid->maps_url) }}" placeholder="Paste Google Maps URL here">
                ...
                <div class="mb-4">
                    ...
                    <div id="map_preview_container" class="w-full h-64 bg-gray-200 rounded-md flex items-center justify-center text-gray-500 overflow-hidden">
                        @if(old('maps_url', $profilPpid->maps_url))
                            <iframe src="{{ old('maps_url', $profilPpid->maps_url) }}" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                        @else
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <div class="flex">
                            ...
                            <input type="text" name="instagram" id="instagram" class="form-input flex-1 rounded-none rounded-r-md shadow-sm border-gray-300 focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50" value="{{ old('instagram', $profilPpid->instagram) }}" placeholder="https://www.instagram.com/username">
                        </div>
                    ...
                    <div>
                        ...
                        <div class="flex">
                            ...
                            <input type="text" name="facebook" id="facebook" class="form-input flex-1 rounded-none rounded-r-md shadow-sm border-gray-300 focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50" value="{{ old('facebook', $profilPpid->facebook) }}" placeholder="https://www.facebook.com/username">
                        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <div class="flex">
                            ...
                            <input type="text" name="twitter" id="twitter" class="form-input flex-1 rounded-none rounded-r-md shadow-sm border-gray-300 focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50" value="{{ old('twitter', $profilPpid->twitter) }}" placeholder="https://twitter.com/username">
                        </div>
                    ...
                    <div>
                        ...
                        <div class="flex">
                            ...
                            <input type="text" name="tiktok" id="tiktok" class="form-input flex-1 rounded-none rounded-r-md shadow-sm border-gray-300 focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50" value="{{ old('tiktok', $profilPpid->tiktok) }}" placeholder="https://www.tiktok.com/@@username">
                        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <div class="flex">
                            ...
                            <input type="text" name="youtube" id="youtube" class="form-input flex-1 rounded-none rounded-r-md shadow-sm border-gray-300 focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50" value="{{ old('youtube', $profilPpid->youtube) }}" placeholder="https://www.youtube.com/@@channel">
                        </div>
                    ...
                    <div>
                        ...
                        <div class="flex">
                            ...
                            <input type="text" name="website" id="website" class="form-input flex-1 rounded-none rounded-r-md shadow-sm border-gray-300 focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50" value="{{ old('website', $profilPpid->website) }}" placeholder="https://www.sinjaikab.go.id">
                        </div>
            ...
            <div class="flex justify-end space-x-3">
                ...
                <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded-lg transition">Update</button>
            </div>
        </form>
    </div>
