...
<div class="relative min-h-screen bg-gray-50 pt-8 pb-16">
    ...
    <div class="container max-w-5xl mx-auto px-4 relative z-10">
        <div class="mb-6 bg-white/10 backdrop-blur-md inline-block px-4 py-2 rounded-xl border border-white/20">
            <x-breadcrumbs :breadcrumbs="[['title' => 'Beranda', 'url' => route('home'), 'icon' => 'fas fa-home text-amber-100'],['title' => 'Informasi Pemkab', 'url' => route('frontend.informasi-pemkab.index'), 'icon' => 'fas fa-file-alt text-amber-100'],['title' => 'Edit Dokumen', 'url' => '#', 'icon' => 'fas fa-edit text-white'],]" />
        </div>
