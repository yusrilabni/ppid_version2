                                ...
                                <div>
                                    ...
                                    <div class="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4">
                                        <label class="flex-1 flex items-center p-3 border border-gray-200 rounded-xl bg-white cursor-pointer hover:border-amber-300 transition-all">
                                            <input type="radio" name="visibility" value="public" x-model="visibility" class="w-4 h-4 text-amber-600 border-gray-300 focus:ring-amber-500" {{ old('visibility', $informasi_pemkab->visibility) == 'public' ? 'checked' : '' }}>
                                        ...
                                        <label class="flex-1 flex items-center p-3 border border-gray-200 rounded-xl bg-white cursor-pointer hover:border-amber-300 transition-all">
                                            <input type="radio" name="visibility" value="private" x-model="visibility" class="w-4 h-4 text-amber-600 border-gray-300 focus:ring-amber-500" {{ old('visibility', $informasi_pemkab->visibility) == 'private' ? 'checked' : '' }}>
