...
@section('content')
    <div class="bg-white rounded-xl shadow p-6">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('admin.organizations.index') }}" class="bg-gray-600 hover:bg-gray-700 text-white font-medium py-2 px-4 rounded-lg transition">
        ...
        <form action="{{ route('admin.organizations.structure.update', $organization) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="max-w-lg mx-auto">
                ...
                {{-- Website URL Input --}}
                <div class="mt-6">
                    <label for="website_url" class="block text-sm font-medium text-gray-700 mb-2">Link Website OPD (Opsional)</label>
                    <input type="url" name="website_url" id="website_url" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 transition" value="{{ old('website_url', $organization->website_url) }}" placeholder="https://www.example.com">
