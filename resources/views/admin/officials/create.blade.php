...
@section('content')
    <div class="bg-white rounded-xl shadow">
        <div class="flex justify-between items-center p-6 mb-6">
            <h2 class="text-xl font-bold text-gray-800">Tambah Profil Pimpinan</h2>
            ...
            <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        ...
                        <div>
                            ...
                            <select name="status_jabatan"
                                ...
                                <option value="Penjabat (Pj)" {{ old('status_jabatan') == 'Penjabat (Pj)' ? 'selected' : '' }}>Penjabat (Pj)</option>
                                <option value="Pelaksana Tugas (Plt)" {{ old('status_jabatan') == 'Pelaksana Tugas (Plt)' ? 'selected' : '' }}>Pelaksana Tugas (Plt)</option>
                                <option value="Pelaksana Harian (Plh)" {{ old('status_jabatan') == 'Pelaksana Harian (Plh)' ? 'selected' : '' }}>Pelaksana Harian (Plh)</option>
                                <option value="Pejabat Sementara (Pjs)" {{ old('status_jabatan') == 'Pejabat Sementara (Pjs)' ? 'selected' : '' }}>Pejabat Sementara (Pjs)</option>
                            </select>
                        ...
                        <div id="organization_field" class="hidden">
                            ...
                            <select name="organization_id_dummy"
                                ...
                                @foreach($organizations as $organization)
                                    <option value="{{ $organization->id }}" {{ old('organization_id', null) == $organization->id ? 'selected' : '' }}>
                                        {{ $organization->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <input type="text" name="occupation" value="{{ old('occupation', '') }}"
                                   class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('occupation') border-red-500 @enderror">
                            @error('occupation')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="home_address" rows="3"
                                      class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('home_address') border-red-500 @enderror">{{ old('home_address', '') }}</textarea>
                            @error('home_address')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <select name="status" required
                                ...
                                <option value="active" {{ old('status', 'draft') == 'active' ? 'selected' : '' }}>Aktif</option>
                                <option value="inactive" {{ old('status', 'draft') == 'inactive' ? 'selected' : '' }}>Tidak Aktif</option>
                            </select>
                            @error('status')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                ...
                <div id="keluarga" class="tab-content hidden">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                        <div id="spouse_name_field_family" class="hidden">
                            <label class="block text-sm font-medium text-gray-700 mb-1" id="spouse_name_label_family">
                                Nama Suami/Istri
                            </label>
                            ...
                            <div class="child-item mb-4 p-4 border rounded-lg">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input type="text" name="children[{{ $index }}][name]" value="" placeholder="Nama anak"
                ...
                <div id="organisasi" class="tab-content hidden">
                    <div id="organizational_fields">
                        @forelse([] as $index => $organizational)
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Trigger change on load to set initial values if they exist from old() helper
            updateHiddenFields();
        });
    </script>
