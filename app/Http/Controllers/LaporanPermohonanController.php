...
class LaporanPermohonanController extends Controller
{
    ...
    public function update(Request $request, PermohonanInformasi $permohonanInformasi)
    {
        ...
        $validatedData = $request->validate([
            ...
            'nomor_telepon_pemohon' => 'required_without:email_pemohon|nullable|string|max:20',
            'email_pemohon' => 'required_without:nomor_telepon_pemohon|nullable|email|max:255',
